...
import { useArea } from "../Sidebar/AreaContext.jsx";
...
const AreaItem = styled('li')(({ theme, isFocused }) => ({
  marginBottom: "15px",
  backgroundColor: isFocused ? theme.palette.action.hover : theme.palette.background.paper,
  padding: "15px",
  borderRadius: "10px",
  boxShadow: "0 2px 8px rgba(0, 0, 0, 0.15)",
  border: `2px solid ${isFocused ? theme.palette.action.hover : theme.palette.divider}`,
...
const Area = () => {
  ...
  const { areas, addArea, deleteArea, updateAreaName, loading } = useArea(); 
